...
class Error
{
    ...
    /**
     * ErrorReporting is a class that handles PHP errors.
     * @param mixed $saveLog Save log or not.
     * @param mixed $logFile Set the log file name.
     */
    public function __construct($saveLog = false, $logFile = 'error.log')
    {
    ...
    /**
     * Sign up for error reporting.
     * @param bool $saveLog Whether to save the log or not.
     * @param string $logFile The name of the log file.
     * @return self
     */
    public static function sign($saveLog = false, $logFile = 'error.log'){
        ...
        <head>
            ...
            <style>
                * {
                ...
                .error-line {
                    background:rgb(61, 177, 230) !important; /* Đỏ nổi bật */
                    color: #fff !important;
                    font-weight: bold;
                    border-left: 6px solid rgb(63, 174, 226); /* Thêm viền trái */
